...
// [GOST] CHANGES START
#define MAGMA_KEY_SIZES_BITS         (ALG_MAGMA * 256)
#define MAGMA_MAX_KEY_SIZE_BITS      (ALG_MAGMA * 256)
#define MAX_MAGMA_KEY_BITS  MAGMA_MAX_KEY_SIZE_BITS
#define MAX_MAGMA_KEY_BYTES BITS_TO_BYTES(MAX_MAGMA_KEY_BITS)
#define MAGMA_BLOCK_SIZES   (ALG_MAGMA * 8)
#define MAX_MAGMA_BLOCK_SIZE_BYTES (ALG_MAGMA * 8)
#define MAGMA_MAX_BLOCK_SIZE MAX_MAGMA_BLOCK_SIZE_BYTES

#define GRASSHOPPER_KEY_SIZES_BITS         (ALG_GRASSHOPPER * 256)
#define GRASSHOPPER_MAX_KEY_SIZE_BITS      (ALG_GRASSHOPPER * 256)
#define MAX_GRASSHOPPER_KEY_BITS  GRASSHOPPER_MAX_KEY_SIZE_BITS
#define MAX_GRASSHOPPER_KEY_BYTES BITS_TO_BYTES(MAX_GRASSHOPPER_KEY_BITS)
#define GRASSHOPPER_BLOCK_SIZES   (ALG_GRASSHOPPER * 16)
#define MAX_GRASSHOPPER_BLOCK_SIZE_BYTES (ALG_GRASSHOPPER * 16)
#define GRASSHOPPER_MAX_BLOCK_SIZE MAX_GRASSHOPPER_BLOCK_SIZE_BYTES
// CHANGES END

// Derived Symmetric Values
// [GOST] Add ALG_MAGMA and ALG_GRASSHOPPER
#define SYM_COUNT ALG_AES + ALG_SM4 + ALG_CAMELLIA + ALG_TDES + ALG_MAGMA + ALG_GRASSHOPPER			// libtpms changed begin
#define MAX_SYM_BLOCK_SIZE \
    MAX(GRASSHOPPER_MAX_BLOCK_SIZE, \
    MAX(MAGMA_MAX_BLOCK_SIZE, \
    MAX(TDES_MAX_BLOCK_SIZE, \
    MAX(CAMELLIA_MAX_BLOCK_SIZE, MAX(SM4_MAX_BLOCK_SIZE, AES_MAX_BLOCK_SIZE)))))
#define MAX_SYM_KEY_BITS \
    MAX(MAGMA_MAX_KEY_SIZE_BITS, MAX(GRASSHOPPER_MAX_KEY_SIZE_BITS, MAX(CAMELLIA_MAX_KEY_SIZE_BITS, MAX(SM4_MAX_KEY_SIZE_BITS, AES_MAX_KEY_SIZE_BITS))))
