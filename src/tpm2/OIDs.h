...
// [GOST] CHANGES START
#ifndef ALG_GOST3411_256
#  define ALG_GOST3411_256 NO
#endif
#if ALG_GOST3411_256
#  define GOST3411_256_OID(NAME) MAKE_OID(NAME##GOST3411_256)
#else
#  define GOST3411_256_OID(NAME)
#endif
#ifndef ALG_GOST3411_512
#  define ALG_GOST3411_512 NO
#endif
#if ALG_GOST3411_512
#  define GOST3411_512_OID(NAME) MAKE_OID(NAME##GOST3411_512)
#else
#  define GOST3411_512_OID(NAME)
#endif
// CHANGES END
...
// [GOST] CHANGES START
#define OID_GOST3411_256_VALUE NIST_HASH, 11
GOST3411_256_OID(_);

#define OID_GOST3411_512_VALUE NIST_HASH, 12
GOST3411_512_OID(_);
// CHANGES END
...
// [GOST] CHANGES START
#  define OID_PKCS1_GOST3411_256_VALUE \
      0x06, 0x09, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x0B
GOST3411_256_OID(_PKCS1_);

#  define OID_PKCS1_GOST3411_512_VALUE \
      0x06, 0x09, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x0D
GOST3411_512_OID(_PKCS1_);
// CHANGES END
...
// [GOST] CHANGES START
#  define OID_ECDSA_GOST3411_256_VALUE \
      0x06, 0x08, 0x2A, 0x86, 0x48, 0xCE, 0x3D, 0x04, 0x03, 0x02
GOST3411_256_OID(_ECDSA_);

#  define OID_ECDSA_GOST3411_512_VALUE \
      0x06, 0x08, 0x2A, 0x86, 0x48, 0xCE, 0x3D, 0x04, 0x03, 0x04
GOST3411_512_OID(_ECDSA_);
// CHANGES END
