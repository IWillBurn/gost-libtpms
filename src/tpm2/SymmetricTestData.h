...
// [GOST] CHANGES START
#if ALG_MAGMA
// GOST R 34.13-2015 Key for 64-bit cipher (A.2).
const BYTE key_MAGMA[] = {
...
// Plaintext from GOST R 34.13-2015 (A.2).
const BYTE dataIn_MAGMA[] = {
...
/* magma-ctr  MakeIv(CTR,8)=[f8..ff], iv_len=4 so only [f8..fb] used */
const BYTE dataOut_MAGMA_CTR[] = {
    0xCB, 0x0A, 0x74, 0x45, 0x7D, 0xB0, 0xC5, 0x8E, 
    0x39, 0x3E, 0x58, 0x1F, 0x10, 0xFB, 0x9E, 0x6B, 
    0x33, 0x27, 0x57, 0x11, 0x9C, 0x26, 0x21, 0xCD, 
    0xCF, 0xA8, 0x14, 0xB5, 0xE8, 0x7C, 0x51, 0x70
};

/* magma-cbc  MakeIv(other,8)=[00..07] */
const BYTE dataOut_MAGMA_CBC[] = {
    0x5D, 0x4A, 0x4B, 0x63, 0xDD, 0x08, 0x6F, 0x5D, 
    0x11, 0x19, 0x5A, 0xA0, 0xA8, 0xB9, 0x9D, 0xB5, 
    0x30, 0x88, 0xA0, 0x97, 0x7D, 0xF4, 0xAF, 0x66, 
    0x92, 0x86, 0x53, 0x61, 0x16, 0xCB, 0x41, 0x8E
};

/* magma-ecb  (no IV) */
const BYTE dataOut_MAGMA_ECB[] = {
...
#if ALG_GRASSHOPPER
// GOST R 34.13-2015 Key for 128-bit cipher (A.1).
const BYTE key_GRASSHOPPER[] = {
...
/* kuznyechik-ctr  MakeIv(CTR,16)=[f0..ff], iv_len=8 so only [f0..f7] used */
const BYTE dataOut_GRASSHOPPER_CTR[] = {
    0xF9, 0x6B, 0x6C, 0x2A, 0x59, 0x6F, 0x38, 0xD5, 
    0x70, 0x23, 0xA5, 0x1A, 0xEA, 0xB3, 0x17, 0x15, 
    0xEF, 0x4D, 0x68, 0x72, 0xAE, 0xCF, 0x80, 0x4B, 
    0x36, 0x2B, 0x21, 0x8E, 0xAB, 0x49, 0xE7, 0xFC, 
    0xEE, 0x5C, 0xF8, 0x9D, 0x99, 0xDE, 0x07, 0x4D, 
    0xEF, 0x2E, 0xD9, 0x51, 0xA7, 0x6D, 0x52, 0xE7, 
    0xFA, 0xEF, 0x1F, 0x9B, 0xFA, 0x15, 0x6B, 0xE2, 
    0xDD, 0xD5, 0xBE, 0x3D, 0xDF, 0xCD, 0x15, 0x43
};

/* kuznyechik-ofb  MakeIv(other,16)=[00..0f] */
const BYTE dataOut_GRASSHOPPER_OFB[] = {
    0xB6, 0x8F, 0x9B, 0x9C, 0x80, 0x03, 0xE3, 0x86, 
    0xAC, 0xB4, 0x1E, 0x03, 0x96, 0x2E, 0xEF, 0x98, 
    0x65, 0x89, 0x75, 0xED, 0x79, 0xD6, 0xE5, 0xB3, 
    0xBC, 0x65, 0x72, 0x8E, 0x0A, 0xDA, 0xF7, 0x69, 
    0x96, 0xC9, 0xBA, 0x10, 0xD9, 0xF9, 0x12, 0xAE, 
    0xE3, 0x5A, 0x47, 0xB0, 0xD9, 0x35, 0x87, 0x0F, 
    0x89, 0xBA, 0x8B, 0xF8, 0x65, 0x98, 0x2D, 0x4C, 
    0x9B, 0xE9, 0xF9, 0x4F, 0x2D, 0xEB, 0x64, 0x0A
};

/* kuznyechik-cbc  MakeIv(other,16)=[00..0f] */
const BYTE dataOut_GRASSHOPPER_CBC[] = {
    0x4D, 0xDE, 0xEA, 0xCD, 0xBE, 0x5F, 0x61, 0x38, 
    0x68, 0x0A, 0x77, 0x7C, 0x52, 0x77, 0x38, 0xB0, 
    0xAF, 0x5A, 0xA2, 0xB8, 0x1E, 0xD5, 0x2D, 0xDC, 
    0x42, 0x23, 0x8A, 0xC8, 0xF8, 0x9D, 0x8B, 0xC6, 
    0x97, 0xEA, 0xF0, 0x65, 0xA1, 0x41, 0xE6, 0x67, 
    0xF5, 0x57, 0x06, 0x11, 0x42, 0xE9, 0x47, 0xE5, 
    0xC7, 0xFD, 0x6C, 0xA0, 0x93, 0x58, 0x53, 0x9B, 
    0xAA, 0x12, 0xAF, 0xD4, 0x5A, 0xC4, 0x39, 0xCF
};

/* kuznyechik-cfb  MakeIv(other,16)=[00..0f] */
const BYTE dataOut_GRASSHOPPER_CFB[] = {
    0xB6, 0x8F, 0x9B, 0x9C, 0x80, 0x03, 0xE3, 0x86, 
    0xAC, 0xB4, 0x1E, 0x03, 0x96, 0x2E, 0xEF, 0x98, 
    0x2D, 0x0F, 0x3F, 0x8B, 0x42, 0xAF, 0xA3, 0x6D, 
    0x07, 0xD9, 0x50, 0xFF, 0x3F, 0xC1, 0xCE, 0x62, 
    0x95, 0x3F, 0xC5, 0xEF, 0x4B, 0xC6, 0x3E, 0xBE, 
    0x5B, 0x2D, 0x9E, 0x3D, 0x1B, 0x48, 0xA9, 0x68, 
    0x24, 0x6E, 0xDE, 0x6E, 0x1C, 0x9B, 0xC1, 0x50, 
    0x27, 0x19, 0xF6, 0x63, 0x5D, 0x4E, 0x66, 0xCD
};

/* kuznyechik-ecb  (no IV) */
const BYTE dataOut_GRASSHOPPER_ECB[] = {
