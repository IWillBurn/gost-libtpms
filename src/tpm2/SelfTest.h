...
// [GOST] CHANGES START
#define MAGMA_ENTRIES ALG_MAGMA
#define GRASSHOPPER_ENTRIES ALG_GRASSHOPPER
// [GOST] CHANGES END

#define NUM_SYMS (AES_ENTRIES + SM4_ENTRIES + CAMELLIA_ENTRIES + TDES_ENTRIES + MAGMA_ENTRIES + GRASSHOPPER_ENTRIES)		// libtpmss added TDES_ENTRIES
