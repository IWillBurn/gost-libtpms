...
#  if ECC_TC26_GOST3410_256_PARAM_SET_A
    comma{TPM_ECC_TC26_GOST3410_256_PARAM_SET_A,
          256,
          {TPM_ALG_KDF1_SP800_56A, {{TPM_ALG_GOST3411_256}}},
          {TPM_ALG_NULL, {{TPM_ALG_NULL}}},
          OID_ECC_TC26_GOST3410_256_PARAM_SET_A CURVE_NAME("TC26_GOST3410_256_PARAM_SET_A")}
#    undef comma
#    define comma ,
#  endif  // ECC_TC26_GOST3410_256_PARAM_SET_A

#  if ECC_TC26_GOST3410_256_PARAM_SET_B
    comma{TPM_ECC_TC26_GOST3410_256_PARAM_SET_B,
          256,
          {TPM_ALG_KDF1_SP800_56A, {{TPM_ALG_GOST3411_256}}},
          {TPM_ALG_NULL, {{TPM_ALG_NULL}}},
          OID_ECC_TC26_GOST3410_256_PARAM_SET_B CURVE_NAME("TC26_GOST3410_256_PARAM_SET_B")}
#    undef comma
#    define comma ,
#  endif  // ECC_TC26_GOST3410_256_PARAM_SET_B

#  if ECC_TC26_GOST3410_256_PARAM_SET_C
    comma{TPM_ECC_TC26_GOST3410_256_PARAM_SET_C,
          256,
          {TPM_ALG_KDF1_SP800_56A, {{TPM_ALG_GOST3411_256}}},
          {TPM_ALG_NULL, {{TPM_ALG_NULL}}},
          OID_ECC_TC26_GOST3410_256_PARAM_SET_C CURVE_NAME("TC26_GOST3410_256_PARAM_SET_C")}
#    undef comma
#    define comma ,
#  endif  // ECC_TC26_GOST3410_256_PARAM_SET_C

#  if ECC_TC26_GOST3410_256_PARAM_SET_D
    comma{TPM_ECC_TC26_GOST3410_256_PARAM_SET_D,
          256,
          {TPM_ALG_KDF1_SP800_56A, {{TPM_ALG_GOST3411_256}}},
          {TPM_ALG_NULL, {{TPM_ALG_NULL}}},
          OID_ECC_TC26_GOST3410_256_PARAM_SET_D CURVE_NAME("TC26_GOST3410_256_PARAM_SET_D")}
#    undef comma
#    define comma ,
#  endif  // ECC_TC26_GOST3410_256_PARAM_SET_D

#  if ECC_TC26_GOST3410_512_PARAM_SET_A
    comma{TPM_ECC_TC26_GOST3410_512_PARAM_SET_A,
          512,
          {TPM_ALG_KDF1_SP800_56A, {{TPM_ALG_GOST3411_512}}},
          {TPM_ALG_NULL, {{TPM_ALG_NULL}}},
          OID_ECC_TC26_GOST3410_512_PARAM_SET_A CURVE_NAME("TC26_GOST3410_512_PARAM_SET_A")}
#    undef comma
#    define comma ,
#  endif  // ECC_TC26_GOST3410_512_PARAM_SET_A

#  if ECC_TC26_GOST3410_512_PARAM_SET_B
    comma{TPM_ECC_TC26_GOST3410_512_PARAM_SET_B,
          512,
          {TPM_ALG_KDF1_SP800_56A, {{TPM_ALG_GOST3411_512}}},
          {TPM_ALG_NULL, {{TPM_ALG_NULL}}},
          OID_ECC_TC26_GOST3410_512_PARAM_SET_B CURVE_NAME("TC26_GOST3410_512_PARAM_SET_B")}
#    undef comma
#    define comma ,
#  endif  // ECC_TC26_GOST3410_512_PARAM_SET_B

#  if ECC_TC26_GOST3410_512_PARAM_SET_C
    comma{TPM_ECC_TC26_GOST3410_512_PARAM_SET_C,
          512,
          {TPM_ALG_KDF1_SP800_56A, {{TPM_ALG_GOST3411_512}}},
          {TPM_ALG_NULL, {{TPM_ALG_NULL}}},
          OID_ECC_TC26_GOST3410_512_PARAM_SET_C CURVE_NAME("TC26_GOST3410_512_PARAM_SET_C")}
#    undef comma
#    define comma ,
