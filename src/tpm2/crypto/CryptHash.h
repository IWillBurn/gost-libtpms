...
// [GOST] CHANGES START
#if ALG_GOST3411_256
#  define IF_IMPLEMENTED_GOST3411_256(op) op(GOST3411_256, Gost3411_256)
#else
#  define IF_IMPLEMENTED_GOST3411_256(op)
#endif
#if ALG_GOST3411_512
#  define IF_IMPLEMENTED_GOST3411_512(op) op(GOST3411_512, Gost3411_512)
#else
#  define IF_IMPLEMENTED_GOST3411_512(op)
#endif
// CHANGES END

// [GOST] + IF_IMPLEMENTED_GOST3411_256 + IF_IMPLEMENTED_GOST3411_512
#define FOR_EACH_HASH(op)       \
    ...
    IF_IMPLEMENTED_GOST3411_256(op) \
    IF_IMPLEMENTED_GOST3411_512(op)
