...
// [GOST] CHANGES START
#if ALG_GOST3411_256
    {TPM_ALG_GOST3411_256, TPMA_ALGORITHM_INITIALIZER(0, 0, 1, 0, 0, 0, 0, 0, 0)},
#endif
#if ALG_GOST3411_512
    {TPM_ALG_GOST3411_512, TPMA_ALGORITHM_INITIALIZER(0, 0, 1, 0, 0, 0, 0, 0, 0)},
#endif
#if ALG_MAGMA
    {TPM_ALG_MAGMA, TPMA_ALGORITHM_INITIALIZER(0, 1, 0, 0, 0, 0, 0, 0, 0)},
#endif
#if ALG_GRASSHOPPER
    {TPM_ALG_GRASSHOPPER, TPMA_ALGORITHM_INITIALIZER(0, 1, 0, 0, 0, 0, 0, 0, 0)},
#endif
// CHANGES END
...
// [GOST] CHANGES START
#if ALG_GOST3410_256
    {TPM_ALG_GOST3410_256, TPMA_ALGORITHM_INITIALIZER(1, 0, 0, 0, 0, 1, 0, 0, 0)},
#endif
#if ALG_GOST3410_512
    {TPM_ALG_GOST3410_512, TPMA_ALGORITHM_INITIALIZER(1, 0, 0, 0, 0, 1, 0, 0, 0)},
#endif
// CHANGES END
